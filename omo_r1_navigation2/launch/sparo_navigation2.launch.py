...
def generate_launch_description():
    ...
    loc_test_dir = get_package_share_directory('omo_r1_navigation2')
    loc_launch_file_dir = os.path.join(loc_test_dir, 'launch')
    
    nav_dir = get_package_share_directory('nav2_bringup')
    nav2_launch_file_dir = os.path.join(nav_dir, 'launch')
    ...
    bringup_cmd_group = GroupAction([
       ...
       IncludeLaunchDescription(
        #   PythonLaunchDescriptionSource(os.path.join(nav2_launch_file_dir, 'navigation_launch.py')),
          PythonLaunchDescriptionSource(os.path.join(loc_launch_file_dir, 'nav_test.launch.py')),
           launch_arguments={'namespace': namespace,
                             'use_sim_time': use_sim_time,
                             'autostart': autostart,
                             'params_file': params_file,
